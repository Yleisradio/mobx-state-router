...
var RouterLink = /** @class */ (function (_super) {
    ...
    function RouterLink() {
        ...
        _this.handleClick = function (event) {
            ...
            var _a = _this.props, rootStore = _a.rootStore, routeName = _a.routeName, params = _a.params, queryParams = _a.queryParams, options = _a.options, onClick = _a.onClick;
    ...
    RouterLink.prototype.render = function () {
        var _a = this.props, routerStore = _a.rootStore.routerStore, routeName = _a.routeName, params = _a.params, queryParams = _a.queryParams, className = _a.className, activeClassName = _a.activeClassName, options = _a.options, children = _a.children, href = _a.href, // remove from `...others`
        onClick = _a.onClick, // remove from `...others`
        others = __rest(_a, ["rootStore", "routeName", "params", "queryParams", "className", "activeClassName", "options", "children", "href", "onClick"]);
